...
- (IBAction)newDeviceSelected:(id)sender
{
	...
	if (selectedDevice != NULL)
	{
		...
		[applyDetectedVideoMode setState:(selectedDevice->deviceSupportsFormatDetection() ? NSControlStateValueOn : NSControlStateValueOff)];
...
- (void)startCapture
{
	if (selectedDevice && selectedDevice->startCapture([[modeListPopup selectedItem] tag], screenPreviewCallback, ([applyDetectedVideoMode state] == NSControlStateValueOn)))
	{
		// Update UI
