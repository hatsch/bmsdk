...
- (com_ptr<HDRVideoFrame>) CreateColorbarsFrame
{
	...
	// Generate video frame with HDR metadata
	com_ptr<HDRVideoFrame> displayHDRFrame = make_com_ptr<HDRVideoFrame>(displayFrame, selectedHDRParameters);
	...
	else
	{
		...
		com_ptr<HDRVideoFrame> referenceHDRFrame = make_com_ptr<HDRVideoFrame>(referenceFrame, selectedHDRParameters);
